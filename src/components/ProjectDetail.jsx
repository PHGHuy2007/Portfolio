...
const ProjectDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Phan Hoàng Gia Huy</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Phan Hoàng Gia Huy — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Phan Hoàng Gia Huy`}
        />
        <meta
